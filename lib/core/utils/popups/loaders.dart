...
class Loaders {
  ...
  static sucessToast({required message, required context}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Container(
          ...
          child: Center(child: Text(message, style: Theme.of(context).textTheme.titleSmall!.apply(color: Colors.white))),
        ),
      ),
    );
  }

  static errorToast({required message, required context}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        elevation: 0,
        duration: const Duration(seconds: 3),
